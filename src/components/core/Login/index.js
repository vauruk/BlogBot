      ...
      <SafeAreaView>
        <View style={[{backgroundColor: theme.WHITE_COLOR}]}>
          <Modal
            ...
            <TouchableOpacity style={styles.bodyPopup} activeOpacity={1}>
                ...
                <Grid style={{marginTop: 30}}>
                  ...
                  <Col>
                    <Button
                      ...
                      {loadingForgot && <Spinner color={theme.WHITE_COLOR} />}
                    </Button>
                  </Col>
                </Grid>
              </View>
                ...
                <View style={[styles.centerGrid, {marginTop: 40}]}>
                  {errorAuthMessage && (
                    <Text
                      ...
                      {I18n.get(errorAuthMessage)}
                    </Text>
                  )}
                  {!errorAuthMessage && <Text></Text>}
                </View>
                <Form>
                  <Item
                    style={{
                  ...
                  <Item
                    ...
                    <Icon
                      ...
                      name="key"
                      size={20}
                      style={{marginLeft: 5, color: theme.PRIMARY_COLOR_FONT}}
                    />
                    <Input
                      value={textPassword}
                      placeholderTextColor={theme.PRIMARY_COLOR_FONT}
